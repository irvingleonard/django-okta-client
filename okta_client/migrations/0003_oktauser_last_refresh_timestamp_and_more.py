...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.DateTimeField(auto_now_add=True, help_text='The last time the user was updated (refreshed) from Okta', null=True, verbose_name='Last refresh timestamp'),
        ),
        migrations.AddField(
            model_name='oktauser',
            name='okta_activated',
        ...
        migrations.AddField(
            model_name='oktauser',
            name='okta_id',
            field=models.CharField(blank=True, help_text='Okta internal ID for the user.', max_length=50, unique=True, verbose_name='id'),
        ),
        migrations.AddField(
            model_name='oktauser',
            name='okta_status',
