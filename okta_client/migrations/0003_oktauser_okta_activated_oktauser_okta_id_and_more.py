...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='oktauser',
            name='okta_id',
            field=models.CharField(blank=True, help_text='Okta internal ID for the user.', max_length=50, verbose_name='id'),
        ),
        migrations.AddField(
            model_name='oktauser',
            name='okta_status',
            field=models.CharField(blank=True, choices=[('STAGED', 'Staged'), ('PROVISIONED', 'Pending User Action'), ('ACTIVE', 'Active'), ('RECOVERY', 'Password Reset'), ('PASSWORD_EXPIRED', 'Password Expired'), ('LOCKED_OUT', 'Locked Out'), ('SUSPENDED', 'Suspended'), ('DEACTIVATED', 'Deactivated')], help_text='Status of the Okta account.', max_length=30, verbose_name='status'),
        ),
        migrations.AddField(
            model_name='oktauser',
            name='okta_status_changed',
            field=models.DateTimeField(blank=True, help_text='Timestamp of the last update of the "status" attribute.', null=True, verbose_name='date joined'),
        ),
        ...
        migrations.AlterField(
            model_name='oktauser',
            name='date_joined',
            field=models.DateTimeField(auto_now_add=True, help_text='Corresponds to "created" attribute of the Okta account or the timestamp when the local account was created', verbose_name='created'),
        ),
        migrations.AlterField(
            model_name='oktauser',
            name='department',
